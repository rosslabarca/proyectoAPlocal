...
import com.Proyecto_Integrador_AP.SpringBoot.Dto.dtoEducacion;
...
import com.Proyecto_Integrador_AP.SpringBoot.service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getFechaIni(), dtoeducacion.getFechaFin(), dtoeducacion.getImagen(), dtoeducacion.getUrlEdu());
    ...
    educacion.setUrlEdu(dtoeducacion.getUrlEdu());
