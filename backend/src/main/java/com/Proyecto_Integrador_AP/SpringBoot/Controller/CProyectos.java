...
import com.Proyecto_Integrador_AP.SpringBoot.Dto.dtoProyectos;
...
import com.Proyecto_Integrador_AP.SpringBoot.service.SProyectos;
...
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproyectos){
        ...
        dtoproyectos.getNombreP(), dtoproyectos.getDescripcionP(), dtoproyectos.getImagenP(), dtoproyectos.getUrl());
